...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton.setGeometry(QtCore.QRect(160, 70, 81, 23))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(Dialog)
        self.pushButton_2.setGeometry(QtCore.QRect(160, 150, 81, 23))
        ...
        self.pushButton_2.released.connect(self.lineEdit_2.paste)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton.setText(_translate("Dialog", "Click Me First!"))
        self.pushButton_2.setText(_translate("Dialog", "I\'m Second!"))
        self.label.setText(_translate("Dialog", "Enter text to copy:"))
        self.label_2.setText(_translate("Dialog", "Text gets pasted here:"))
